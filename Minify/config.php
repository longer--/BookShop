...
/** Santino Wu - 140202 - 配置缓存目录 */
/** @todo 无效 */
//$min_cachePath = '/var/www/santinocom/Runtime/Temp';
/**
...
/** Santino Wu - 140202 - 配置文件目录 */
$min_serveOptions['minApp']['allowDirs'] = array('//Public/js', '//Public/css');
